        ...
        <Dialog>
            ...
            <DialogContent className="p-0 max-w-3xl rounded-xl overflow-hidden border-0 shadow-xl">
                ...
                {currentStep === 'select' ? (
                    <div className="flex flex-col">
                        ...
                        <div
                            className={`
                                ...
                                min-h-[550px] bg-background
                                ${isDragging ? 'bg-[#ec3750]/5 border-[#ec3750]' : ''}
                                border-2 border-dashed border-border m-6 rounded-lg
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-muted-foreground mb-12 text-lg">Share your latest hack, project, or idea</p>
                                <Button
                                    type="button"
                                    className="bg-[#ec3750] hover:bg-[#ec3750]/90 text-primary-foreground px-6 py-2 text-base h-auto"
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        openFileDialog();
                                    }}
                    ...
                    <div className="flex">
                        <div className="flex-1 relative bg-muted-foreground">
                            <button
                                className="absolute left-4 top-4 z-10 bg-muted-foreground/40 hover:bg-muted-foreground/60 text-background rounded-full p-1"
                            ...
                            <Carousel className="w-full">
                                            ...
                                            <CarouselItem key={index} className="flex items-center justify-center p-0">
                                                {file.type.startsWith('image/') ? (
                                                    ...
                                                    <div className="text-background p-8">
                                                        ...
                                                        <p className="mt-2 text-background/80">{file.name}</p>
                                                    </div>
                                                )}
                                            </CarouselItem>
                                        );
                                ...
                                {files.length > 1 && (
                                    <>
                                        <CarouselPrevious className="absolute left-3 top-1/2 -translate-y-1/2 bg-muted-foreground/30 hover:bg-muted-foreground/50 border-none text-background">
                                            <ChevronLeft className="h-6 w-6" />
                                        </CarouselPrevious>
                                        <CarouselNext className="absolute right-3 top-1/2 -translate-y-1/2 bg-muted-foreground/30 hover:bg-muted-foreground/50 border-none text-background">
                        ...
                        <div className="w-[350px] flex flex-col bg-card border-l">
                            ...
                            <div className="p-4 border-t flex justify-between items-center">
                                <div className="flex items-center">
                                    <ImageIcon size={18} className="text-muted-foreground mr-2" />
                                ...
                                <Button
                                    type="submit"
                                    className="bg-[#ec3750] hover:bg-[#ec3750]/90 text-primary-foreground"
                                    onClick={handleShare}
